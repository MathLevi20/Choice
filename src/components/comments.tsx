      ...
      <div className="max-w-md mx-auto bg-white p-3 min-[320px]:m-4 sm:m-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 w-full  mb-4">
          <input
            ...
            className="flex-grow rounded sm:rounded-r-sm  px-4 py-2 border col-span-3 border-gray-400 focus:outline-none focus:ring-purple-500 focus:border-purple-500" />
          <button
            onClick={addComment}
            className="rounded sm:rounded-l-sm my-1 sm:my-0  bg-purple-500 text-white font-bold py-2 px-4  focus:outline-none hover:bg-purple-600 transition duration-200"
          >
            Enviar
          </button>
        </div>
